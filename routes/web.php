...
Route::group(array('domain' => '127.0.0.1'), function () {
    ...
    Route::get('/', 'ControladorWebIndex@index');
    Route::get('/informacion', 'ControladorWebIndex@info');
    Route::get('/inscripciones', 'ControladorWebInscripcion@index');
    Route::post('/inscripciones', 'ControladorWebInscripcion@guardar');
    Route::get('/gracias', 'ControladorWebInscripcion@gracias');


    Route::get('/grupo/{id}', 'ControladorEscuadra@init');
...
Route::get('/admin/clasificacion', 'ControladorClasificacion@index');
Route::post('/admin/clasificacion', 'ControladorClasificacion@guardar');

Route::get('/admin/clasificacion/{id}', 'ControladorClasificacion@update');
Route::post('/admin/clasificacion/{id}', 'ControladorClasificacion@guardar');
Route::get('/admin/clasificacion/eliminar/{id}', 'ControladorClasificacion@eliminar');

Route::get('/admin/lista/clacificacion', 'ControladorClasificacion@lista');
Route::get('/admin/lista/clacificacion/cargarGrilla', 'ControladorClasificacion@cargarGrilla')->name('clacificacion.cargarGrilla');

/* --------------------------------------------- */
/* CONTROLADOR escuadra                      */
/* --------------------------------------------- */
Route::get('/admin/escuadra', 'ControladorEscuadra@index');
Route::post('/admin/escuadra', 'ControladorEscuadra@guardar');

Route::get('/admin/escuadra/{id}', 'ControladorEscuadra@update');
Route::post('/admin/escuadra/{id}', 'ControladorEscuadra@guardar');
Route::get('/admin/escuadra/eliminar/{id}', 'ControladorEscuadra@eliminar');




Route::get('/admin/lista/escuadras', 'ControladorEscuadra@lista');
Route::get('/admin/lista/escuadras/cargarGrilla', 'ControladorEscuadra@cargarGrilla' )->name('escuadra.cargarGrilla');
/* --------------------------------------------- */
